...
public class Materi3_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String Title3 = intent1.getExtras().getString("Title");
        String Video3 = intent1.getExtras().getString("Video");

        //setting
        materitvttitle.setText(Title3);
        videoMateri.setVideoPath(Video3);
    }
}
