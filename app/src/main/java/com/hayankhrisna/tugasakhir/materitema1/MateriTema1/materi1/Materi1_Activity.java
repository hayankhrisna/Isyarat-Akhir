...
public class Materi1_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String Title1 = intent1.getExtras().getString("Title");
        String Video1 = intent1.getExtras().getString("Video");

        //setting
        materitvttitle.setText(Title1);
        videoMateri.setVideoPath(Video1);
    }
}
